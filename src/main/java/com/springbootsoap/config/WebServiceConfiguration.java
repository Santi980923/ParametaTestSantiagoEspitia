...
public class WebServiceConfiguration {
    ...
    public Jaxb2Marshaller marshaller() {
        ...
        marshaller.setContextPath("com.springbootsoap.gen");
        return marshaller;
    }

    @Bean
    public EmployeeSoapClient employeeClient(Jaxb2Marshaller marshaller) {
        EmployeeSoapClient client = new EmployeeSoapClient();
        client.setMarshaller(marshaller);
        client.setUnmarshaller(marshaller);
        client.setDefaultUri("http://localhost:8080/allService");
        return client;
    }
}
